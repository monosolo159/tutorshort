...
<!-- CSS Files -->
<link href="http://localhost/tutorjob/assets/template/back/css/main.css" rel="stylesheet" />
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" /></head>

<body class="signup-page">
<div class="wrapper">
  <div class="header header-filter" style="background-image: url('http://localhost/tutorjob/assets/template/back/images/login-bg.jpg'); background-size: cover; background-position: top center;">
    <div class="container">
      <div class="row">
...
<!--  Vendor JavaScripts -->
<script src="http://localhost/tutorjob/assets/themplate/back/bundles/libscripts.bundle.js"></script>

<!--  Custom JavaScripts  -->
<script src="http://localhost/tutorjob/assets/themplate/back/js/main.js"></script>
<!--/ custom javascripts -->
</html>
